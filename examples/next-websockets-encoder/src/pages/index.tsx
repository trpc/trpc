        ...
        <div className="mx-auto max-w-2xl space-y-8">
          ...
          <section className="rounded-lg bg-gray-800 p-6 space-y-4">
            ...
            <p className="text-xs text-gray-500">
              ...
              {randomNumberSub.error && ` | Error: ${randomNumberSub.error.message}`}
            </p>
            ...
            {messages.length > 0 && (
              <div className="mt-4 space-y-1">
                <p className="text-xs text-gray-500">Recent messages ({messages.length}):</p>
                <div className="font-mono text-xs text-gray-400 bg-gray-900 p-2 rounded max-h-32 overflow-y-auto">
                  {messages.map((msg, i) => (
