...
> = inferProcedureInput<TProcedure> extends CursorInput
  ? {
      /**
       * @link https://trpc.io/docs/client/react/suspense#useinfinitesuspensequery
       */
      useInfiniteQuery: (
      ...
      >;
      /**
       * @link https://trpc.io/docs/client/react/suspense
       */
...
> = {
  /**
   * @link https://trpc.io/docs/client/react/useQuery
   */
  useQuery: ProcedureUseQuery<TConfig, TProcedure>;
  /**
   * @link https://trpc.io/docs/client/react/suspense#usesuspensequery
   */
  useSuspenseQuery: <
    TQueryFnData extends inferTransformedProcedureOutput<
      TConfig,
...
> {
  /**
   * @link https://trpc.io/docs/client/react/useMutation
   */
...
export type CreateTRPCReactBase<TRouter extends AnyRouter, TSSRContext> = {
   ...
   *
   * @link https://trpc.io/docs/client/react/useUtils
   */
