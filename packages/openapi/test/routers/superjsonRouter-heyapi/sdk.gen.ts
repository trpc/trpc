...
export class Sdk extends HeyApiClient {
    ...
    public getEvent<ThrowOnError extends boolean = false>(options: Options<GetEventData, ThrowOnError>): RequestResult<GetEventResponses, GetEventErrors, ThrowOnError> {
        return (options.client ?? this.client).get<GetEventResponses, GetEventErrors, ThrowOnError>({ url: '/getEvent', ...options });
    }
    
    public createEvent<ThrowOnError extends boolean = false>(options: Options<CreateEventData, ThrowOnError>): RequestResult<CreateEventResponses, CreateEventErrors, ThrowOnError> {
    ...
    public getBigInt<ThrowOnError extends boolean = false>(options: Options<GetBigIntData, ThrowOnError>): RequestResult<GetBigIntResponses, GetBigIntErrors, ThrowOnError> {
