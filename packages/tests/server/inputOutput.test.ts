...
test('no input', async () => {
  ...
  expectTypeOf<ProcType['_inputOutputs'][0]['inputIn']>().toEqualTypeOf<UnsetMarker>();
  expectTypeOf<ProcType['_inputOutputs'][0]['inputOut']>().toEqualTypeOf<UnsetMarker>();
  expectTypeOf<ProcType['_inputOutputs'][0]['outputIn']>().toBeUndefined();
  expectTypeOf<ProcType['_inputOutputs'][0]['outputOut']>().toBeUndefined();
...
test('zod default() string', async () => {
  ...
  expectTypeOf<ProcType['_inputOutputs'][0]['inputIn']>().toEqualTypeOf<string | undefined>();
  expectTypeOf<ProcType['_inputOutputs'][0]['inputOut']>().toEqualTypeOf<string>();
...
test('zod default() required object', async () => {
  ...
  expectTypeOf<ProcType['_inputOutputs'][0]['inputIn']>().toEqualTypeOf<{ foo?: string }>();
  expectTypeOf<ProcType['_inputOutputs'][0]['inputOut']>().toEqualTypeOf<{ foo: string }>();
...
test('zod default() mixed default object', async () => {
  ...
  expectTypeOf<ProcType['_inputOutputs'][0]['inputIn']>().toEqualTypeOf<
    { foo: string; bar?: string } | undefined
  >();
  expectTypeOf<ProcType['_inputOutputs'][0]['inputOut']>().toEqualTypeOf<{
    foo: string;
    bar: string;
  }>();
...
test('double validators with undefined', async () => {
...

  {
    ...
    type Input = inferProcedureParams<typeof proc>['_inputOutputs'][0]['inputIn'];
    expectTypeOf<Input>().toEqualTypeOf<{
      roomId: string;
      optionalKey?: string;
    }>();
