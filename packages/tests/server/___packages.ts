...
import * as mock_trpcServer__adapters__nodeHTTP__contentType__formData from '../../server/src/adapters/node-http/content-type/form-data';
vi.mock('@trpc/server/adapters/node-http/content-type/form-data', () => mock_trpcServer__adapters__nodeHTTP__contentType__formData);
import * as mock_trpcServer__adapters__nodeHTTP__contentType__json from '../../server/src/adapters/node-http/content-type/json';
vi.mock('@trpc/server/adapters/node-http/content-type/json', () => mock_trpcServer__adapters__nodeHTTP__contentType__json);
