  ...
  return (
    <div className="flex justify-center pt-12 lg:pt-16">
      <figure>
        ...
        <a
          href="#try-it-out"
          className="hidden rounded-lg border-[20px] border-[#111111] bg-[#111111] shadow-[0px_-24px_300px_0px_rgba(57,140,203,0.15)] transition hover:shadow-[0px_-24px_150px_0px_rgba(57,140,203,0.3)] md:block"
