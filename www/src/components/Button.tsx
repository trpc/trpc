...
export const Button = ({
  ...
  const className = clsx(
    'inline-grid appearance-none cursor-pointer text-sm sm:text-base font-bold tracking-normal px-3 py-2.5 sm:px-4 sm:py-2 gap-1.5 sm:gap-1.5 grid-flow-col rounded-lg shadow-xl shadow-sky-500/20 no-underline hover:no-underline justify-center items-center transition-all duration-300 ',
    {
