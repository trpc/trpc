...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'drift',
      content:
        "🚀 We've just announced a beta of <strong>tRPC Drift</strong> that helps you keep track of changes of your API. Check it out at <a href='https://drift.trpc.io'><strong>drift.trpc.io</strong></a>.",
