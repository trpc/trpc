...
For generating a powerful set of React hooks for querying your tRPC API. Powered by [@tanstack/react-query](https://react-query.tanstack.com/).
...
```bash
npm install @trpc/server @trpc/client @trpc/react @tanstack/react-query @trpc/next
```

**yarn:**

```bash
yarn add @trpc/server @trpc/client @trpc/react @tanstack/react-query @trpc/next
```
