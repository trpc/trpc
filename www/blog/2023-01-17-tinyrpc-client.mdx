...
type DecorateRouterRecord<TProcedures extends ProcedureRouterRecord> = {
  [TKey in keyof TProcedures]: TProcedures[TKey] extends AnyRouter
    ? DecorateRouterRecord<TProcedures[TKey]['_def']['record']>
