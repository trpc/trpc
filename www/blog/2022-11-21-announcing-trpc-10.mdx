...
For new projects, you can get up and running with an [example application](https://trpc.io/example-apps) to learn about tRPC v10. For projects that were already enjoying tRPC v9, [visit the v10 migration guide](https://trpc.io/docs/v10/migrate-from-v9-to-v10).
