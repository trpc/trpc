...
- [A growing ecosystem of extensions, examples, and content](https://trpc.io/ecosystem)
...
For new projects, you can get up and running with an [example application](https://trpc.io/ecosystem#starter) to learn about tRPC v10. For projects that were already enjoying tRPC v9, [visit the v10 migration guide](https://trpc.io/docs/v10/migrate-from-v9-to-v10).
...
For more plugins, examples, and adapters, [visit the Awesome tRPC collection](https://trpc.io/ecosystem).
