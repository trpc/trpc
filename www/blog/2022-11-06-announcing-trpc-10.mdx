...
- 15k+ stars on [GitHub](https://github.com/trpc/trpc)
- [A Discord community](https://trpc.io/discord) with over 2,000 members
- [95k+ weekly npm downloads](https://www.npmjs.com/package/@trpc/server)
- [Nearly 200 contributors](https://github.com/trpc/trpc/graphs/contributors)
- [A growing ecosystem of extensions, examples, and content](docs/v10/awesome-trpc)
...
For new projects, you can get up and running with an [example application](https://trpc.io/docs/v10/awesome-trpc#-starting-points-example-projects-etc) to learn about tRPC v10. For projects that were already enjoying tRPC v9, [visit the v10 migration guide](https://trpc.io/docs/v10/migrate-from-v9-to-v10).
...
For more plugins, examples, and adapters, [visit the Awesome tRPC collection](https://trpc.io/docs/awesome-trpc).
