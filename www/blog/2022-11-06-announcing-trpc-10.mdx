...
We're getting a rich ecosystem around tRPC
...
- There are adapters so you can use tRPC easily in Vue/[Svelte](https://github.com/icflorescu/trpc-sveltekit)/Solid/etc - TBD
