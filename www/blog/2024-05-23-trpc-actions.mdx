...
You may think that this sounds similar to tRPC which is true. According to [Dan Abramov](https://bsky.app/profile/danabra.mov), server actions are tRPC as a bundler feature:
