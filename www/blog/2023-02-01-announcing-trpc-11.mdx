...
While tRPC v11 may not come with any new features, we've been working hard behind the scenes to make significant internal improvements that will make using tRPC easier to work with for us, which means we can ship new feature at a higher pace.
