...
We've introduced a new shorthand syntax for defining your router to simplify the process of defining your routes. [Docs](/docs/server/routers#inline-sub-router)
