...
commentDiscussionId: 6621
---

import { GithubSponsorButton } from '@site/src/components/GithubSponsorButton';

Although tRPC v11 has been production-ready for a long time via the `@next` tag, we've gotten kinda addicted to adding new features without being sticklers to semantic versioning. Today, we're excited to _finally_ ripping off the band-aid and announcing the official release of tRPC v11!
