...
```sh
pnpm create next-app --example https://github.com/trpc/trpc --example-path examples/next-prisma-starter-websockets trpc-prisma-starter-websockets
```
...
```
  ...
  <TabItem value="yarn" label="npm" default>

```bash
yarn create trpc-appx --example https://github.com/omar-dulaimi/trpc-shield/tree/master/example
```

  </TabItem>
  <TabItem value="pnpm" label="npm" default>

```bash
pnpm create trpc-appx --example https://github.com/omar-dulaimi/trpc-shield/tree/master/example
```
...
- [Source code](https://github.com/trpc/trpc/tree/next/examples/cloudflare-workers)
