...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>API endpoint - can be a <b className="text-amber-500">query</b> or <b className="text-amber-500">mutation</b></td>
    </tr>
    <tr>
      <td><b className="text-amber-500">Query</b></td>
      <td>A <b className="text-green-500">procedure</b> that gets some data</td>
    </tr>
    <tr>
      <td><b className="text-amber-500">Mutation</b></td>
    ...
    <tr>
      <td><b className="text-pink-500">Context</b> <a href="/docs/server/context">↗</a></td>
    ...
    <tr>
      ...
      <td>Functions executed before and after <b className="text-green-500">procedures</b>, can modify <b className="text-pink-500">context</b></td>
    </tr>
  </tbody>
</table>
...
:::info
A mutation procedure is the equivalent of a POST endpoint in a REST-based API.
:::
