...
tRPC combines concepts from [REST](https://www.sitepoint.com/rest-api/) and [GraphQL](https://graphql.org/). If you're unfamiliar with either, take a look at the key [Concepts](./concepts.mdx).
