...
:::tip
We highly encourage you to check out [the example apps](example-apps.md) to learn about how tRPC is installed in your favorite framework.
:::
...
<!--
    Shiki doesn't play nice in <Tabs /> so I had to rebuild it myself.
    The styles are all coming off of the shiki stylesheet other than
    "manual-nord" which can be found in /src/css/custom.css.
 -->

<Tabs>
  <TabItem value="npm" label="npm" default>
    <pre class="shiki nord manual-nord">
  ...
  <TabItem value="yarn" label="yarn" default>
    <pre class="shiki nord manual-nord">
      <div class="code-container">
        <div class="line">
          yarn add @trpc/server@next @trpc/client@next @trpc/react-query@next
          @trpc/next@next @tanstack/react-query
        </div>
      </div>
    </pre>
...
Use `t.procedure.query()` to add a query procedure/endpoint to the router. The two methods on this procedure are:
...
The way a procedure works on the server doesn't change much between query and mutation. The method name is different and the way that the client will use this procedure changes - but everything else is the same!
