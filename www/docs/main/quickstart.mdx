...
- Usage with React (client-side)
  - [TanStack React Query Integration (Recommended) -> `@trpc/tanstack-react-query`](../client/tanstack-react-query/setup.mdx)
  - [React Query Integration (Classic) -> `@trpc/react-query`](../client/react/introduction.mdx)
