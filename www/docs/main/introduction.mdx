...
For a quick video overview of tRPC's concepts, check out these videos:
...
For more videos and community resources, see the [Videos & Community Resources](./videos-and-community-resources.mdx) page.
...
"Using tRPC" means different things to different people. The goal of this section is to guide you to the right resources based on your goals.
...
- If you are using React, read about the [TanStack React Query Integration](../client/tanstack-react-query/setup.mdx) (recommended) or the [Classic React Query Integration](../client/react/introduction.mdx).
