...
<div align="center">
  <svg width="429" height="100" viewBox="0 0 429 128" fill="none" xmlns="http://www.w3.org/2000/svg">
...
- 🔋&nbsp; Framework agnostic - The tRPC community has built [adapters](https://trpc.io/ecosystem#extension) for all of the most popular frameworks.
