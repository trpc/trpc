...
| Description                                                                                          | Link                                                                    |
| ---------------------------------------------------------------------------------------------------  | ----------------------------------------------------------------------- |
| Step CI - Open Source framework for API Quality Assurance, which tests tRPC and other paradigms automated and from Open API spec | https://github.com/stepci/stepci        
