...
<ContentSlider
  cards={[
    ...
    {
      title: 'Implementing JWT Authentication with TRPC and Express'.
      time: '9m',
      people: ['Temitayo'],
      link: 'https://temitayoogunsusi.hashnode.dev/implementing-jwt-authentication-with-trpc-and-express'
     }
  ]}
/>
