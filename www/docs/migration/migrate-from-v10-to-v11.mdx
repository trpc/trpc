...
unstable_httpSubscriptionLink({
  url: '/api/trpc',
  // Reconnect if no messages or pings are received for 30 seconds
...
The `httpSubscriptionLink` now includes several new features for better connection management:
