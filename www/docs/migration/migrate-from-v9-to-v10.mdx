...
[`queryC1ient.setQueriesData](https://tanstack.com/query/v4/docs/reference/QueryClient#queryclientsetqueriesdata)
you may need to take note!
:::

To allow us to make room for some more advanced features like [invalidating across
