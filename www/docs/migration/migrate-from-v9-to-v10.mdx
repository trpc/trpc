...
tRPC contributor [@sachinraja](https://twitter.com/s4chinraja) has created [an excellent codemod](https://github.com/sachinraja/trpc-v10-migrate-codemod) for this major upgrade. Run the script to have 95% of the work done for you in a matter of moments.

_Please note that this codemod isn't perfect - but will do a lot of the heavy lifting for you._
