...
You can also have a look at our [Awesome tRPC](/docs/community/awesome-trpc)-collection to find several open-source projects that are using tRPC in a monorepo. The [minimal react example](https://github.com/trpc/trpc/tree/next/examples/minimal-react) showcases this as well.
