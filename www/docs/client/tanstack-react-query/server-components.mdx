...
If you need access to the data in a server component, we recommend creating a server caller and using it directly. Please note that this method is de-attached from your query client and does not
