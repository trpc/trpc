...
Create a tRPC client with the `createTRPCProxyClient` method, and add a `links` array with a [terminating link](../advanced/links/overview.md#the-terminating-link) pointing at your API. To learn more about tRPC links, [click here](../links/overview.md).
