...
Create a tRPC client with the `createTRPCProxyClient` method, and add a `links` array with a [terminating link](./advanced/links/index.md#the-terminating-link) pointing at your API. To learn more about tRPC links, [click here](./advanced/links/index.md).
