...
sidebar_label: Setup
slug: /client/nextjs/pages-router/setup
---
...
Browse the rest of the docs to learn more about things like [authorization](/docs/server/authorization), [middlewares](/docs/server/middlewares), and [errors](/docs/server/errors).
