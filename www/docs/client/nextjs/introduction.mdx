...
Our Next.js integration is built on top of our [React Query Integration](/docs/client/react/introduction) with some Next.js specific APIs, to handle both client and server side rendering.
