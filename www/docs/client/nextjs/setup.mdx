...
The Next.js integration is actually a combination of our [React Query Integration](/docs/client/react/introduction) and some Next.js specific integrations.
...
You can now use the React hooks you have just created to invoke your API. For more detail see the [React Query Integration](/docs/client/react/introduction)
...
Configure [overrides for React Query's hooks](/docs/client/react/usecontext#invalidate-full-cache-on-every-mutation).
