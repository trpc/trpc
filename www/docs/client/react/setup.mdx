...
```bash
pnpm add @trpc/client@next @trpc/server@next @trpc/react-query @tanstack/react-query
```
...
```bash
bun add @trpc/client@next @trpc/server@next @trpc/react-query@next @tanstack/react-query
```
