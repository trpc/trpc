...
| Realtime boilerplate server using tRPC, Fastify, Prisma, Redis (incl. type-safe event emitter and event-emitter-2) and PostgreSQL | https://github.com/cobeo2004/trpc-fastify                                                              |
