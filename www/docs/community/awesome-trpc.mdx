...
| Next.js + Express + BetterAuth + Prisma + bun + shadcn + tRPC Monorepo Boilerplate                      | https://github.com/KitsuneKode/template-nextjs-express-trpc-bettera-auth-monorepo           |
