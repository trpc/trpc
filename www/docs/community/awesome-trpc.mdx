...
| create-faster - Scaffold a starter project or use preconfigured blueprints with Next.js, Drizzle, TanStack Query, and many other integrations | https://create.plvo.dev/docs/modules/api/trpc               |
