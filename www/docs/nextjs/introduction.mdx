...
<<<<<<< HEAD:www/docs/nextjs/introduction.md
Recommended but not enforced file structure. This is what you get when starting from [the examples](../main/example-apps.mdx).
=======
We recommend a file structure like this one but it is not enforced by tRPC. This is what you'll get when starting from [the examples](/main/example-apps.mdx).
>>>>>>> origin/next:www/docs/nextjs/introduction.mdx
