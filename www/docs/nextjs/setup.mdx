...
{/* TODO: Nick: tidy up and bring this page in liner with other setup guides */}
...
You can also find usual information about [queries](useQuery) and [mutations](useMutation) now that you're using `@trpc/react-query`.
