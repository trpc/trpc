...
- Zod is a great validation lib that works out of the box, but tRPC also works out-of-the-box with yup/myzod/ts-json-validator - [see test suite](./packages/server/test/validators.test.ts)
