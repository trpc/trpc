...
| [`next-ssg-chat`](./examples/next-ssg-chat)         | Next.js real-time chat example with SSG & Prisma.<br/>Uses [Playwright](https://playwright.dev) for E2E-testing | `yarn example:chat`                                                                                               | [chat.trpc.io](https://chat.trpc.io)               |
