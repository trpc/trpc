<div align="center">
  ...
  <p>
    ...
    <figcaption>The client above does <strong>not</strong> import any code from the server. <em><a href="https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-8.html#type-only-imports-and-export">Import type only imports declarations to be used for type annotations and declarations. It always gets fully erased, so there’s no remnant of it at runtime.</a></em></figcaption>
    </figure>
    <em></em>
  </p>
</div>
