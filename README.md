...
```sh
# yarn
yarn create next-app --example https://github.com/trpc/examples-next-prisma-starter trpc-prisma-starter
# npm
npx create-next-app --example https://github.com/trpc/examples-next-prisma-starter trpc-prisma-starter
```
