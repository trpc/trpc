...
[![codecov](https://codecov.io/gh/trpc/trpc/branch/feature/codecov/graph/badge.svg?token=KPPS918B0G)](https://codecov.io/gh/trpc/trpc) _(this could be improved, although we have some E2E-tests that aren't included)_
