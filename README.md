...
| Folder                                              | Description                                                                                                     | Try it out!                                                                                                       | Live URL                                           |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [`next-hello-world`](./examples/next-hello-world)   | Minimal Next.js example with a mock in-memory db.<br/>Uses [Playwright](https://playwright.dev) for E2E-testing | [CodeSandbox](https://githubbox.com/trpc/trpc/tree/main/examples/next-hello-world)<br/>`yarn example:hello`       | [hello-world.trpc.io](https://hello-world.trpc.io) |
| [`next-ssg-chat`](./examples/next-ssg-chat)         | Next.js real-time chat example with SSG & Prisma.<br/>Uses [Playwright](https://playwright.dev) for E2E-testing | [CodeSandbox](https://githubbox.com/trpc/trpc/tree/main/examples/next-ssg-chat)<br/>`yarn example:chat`           | [chat.trpc.io](https://chat.trpc.io)               |
| [`standalone-server`](./examples/standalone-server) | Standalone tRPC server + node client                                                                            | [CodeSandbox](https://githubbox.com/trpc/trpc/tree/main/examples/standalone-server)<br/>`yarn example:standalone` | _n/a_                                              |
| [`playground`](./examples/playground)               | Express server + node client                                                                                    | [CodeSandbox](https://githubbox.com/trpc/trpc/tree/main/examples/playground)<br/>`yarn example:playground`        | _n/a_                                              |
